...
import org.net.websocket.core.channel.WebSocketChannelInitializer;
...
public class WebSocketServer implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            log.info("WebSocket Server was open: {}", this.port);
            ...
            log.info("WebSocket Server was closed: {}", this.port);
        }
    }
}